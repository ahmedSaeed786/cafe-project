...
<body>
    <div id="container">
        ...
        <div class="heading">
            <h3><span  style="color:#bd0f0f;">{{ $b->game_name ?? 0 }}(id:{{ $b->id ?? 0 }})</span> Booking Expire At</h3>
            <h4 style="color:#bd0f0f;">{{ $b->expiry_time ?? 0 }}</h4>
        </div>
        ...
        <div class="blackdiv">
            ...
            <div class="box1">
                <h2 style="text-">Dear {{ $b->name ?? 0}}</h2>  
                ...
                <p>
                    ...
                    {{$b->expiry_time ?? 0}}</span> has now expired.
                </p>
